...
new class extends Component {
    ...
    //
    public function mount(\App\Models\Category $category = null) {
...
<div>
    <x-card title="Categoria {{ $this->actulizando ? 'Actualizar' : 'Crear' }}" subtitle="agregar o editar categoria" shadow separator>
